...
/**
 * AppPromotionsProspects
 *
 * @ORM\Table(name="app_promotions_prospects")
 * @ORM\Entity(repositoryClass="App\Repository\AppPromotionsProspectsRepository")
 */
class AppPromotionsProspects
{
    /**
     * @var int
     *
