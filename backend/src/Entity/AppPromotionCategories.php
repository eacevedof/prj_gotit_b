...
/**
 * AppPromotionCategories
 *
 * @ORM\Table(name="app_promotion_categories")
 * @ORM\Entity(repositoryClass="App\Repository\AppPromotionCategoriesRepository")
 */
class AppPromotionCategories
{
    /**
     * @var int
     *
