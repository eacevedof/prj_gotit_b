...
class AppPromotionNotifications
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="code_push", type="string", length=500, nullable=true, options={"default"="NULL"})
     */
    private $codePush = null;

    /**
     * @var int|null
     *
     * @ORM\Column(name="id_status", type="integer", nullable=true, options={"default"="NULL","comment"="app_array.id (type=notifstatus) notified,read,suscribed"})
     */
    ...
    public function getCodePush(): ?string
    {
        return $this->codePush;
    }

    public function setCodePush(?string $codePush): self
    {
