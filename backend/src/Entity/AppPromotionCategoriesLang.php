...
/**
 * AppPromotionCategoriesLang
 *
 * @ORM\Table(name="app_promotion_categories_lang")
 * @ORM\Entity(repositoryClass="App\Repository\AppPromotionCategoriesLangRepository")
 */
class AppPromotionCategoriesLang
{
    /**
     * @var int
     *
     ...
     * @var int|null
     *
     * @ORM\Column(name="id_promotion_categories", type="integer", nullable=true, options={"default"="1","comment"="app_promotion_categories.id"})
     */
    private $idPromotionCategories = '1';

    /**
     * @var int
     *
     * @ORM\Column(name="id_language", type="integer", nullable=false, options={"default"="1","comment"="app_languages.id"})
     */
    ...
    public function getIdPromotionCategories(): ?int
    {
        return $this->idPromotionCategories;
    }

    public function setIdPromotionCategories(?int $idPromotionCategories): self
    {
        $this->idPromotionCategories = $idPromotionCategories;
